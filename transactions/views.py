    ...
    def post(request):
        ...
        if operator == Operator.MCI.value:
            ...
            exe_response_type, exe_response_description = EWays().exe_sale(
                package_record.provider_id, '33', package_record.package.PackageCostWithVat, package_record.tell_charger, package_record.package.package_type)
        elif operator == Operator.RIGHTEL.value:
            exe_response_type, exe_response_description = EWays().exe_sale(
                package_record.provider_id, '62', package_record.package.PackageCostWithVat, package_record.tell_charger, package_record.package.package_type)
